 ...
 * BackTracking Forward Checking Constraint Propagation Minimum Remaining Value Naked Pairs
 * Naked pairs: if there is a pair of cells in a region (block, row, column) that have the same two numbers (only),
 * then remove those numbers from the possible numbers for all other cells in the same region.
 */
public class BTFCCPMRVNP implements SuperSolver {

    public String name = "BTFCCPMRVNP";
